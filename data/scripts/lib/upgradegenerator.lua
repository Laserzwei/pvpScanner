...
-- turrets
UpgradeGenerator.add("data/scripts/systems/arbitrarytcs.lua", 2)
UpgradeGenerator.add("data/scripts/systems/militarytcs.lua", 2)
UpgradeGenerator.add("data/scripts/systems/civiltcs.lua", 2)
...
UpgradeGenerator.add("data/scripts/systems/velocitybypass.lua", 0.5)
UpgradeGenerator.add("mods/pvpScanner/scripts/systems/pvpModule.lua", 1)
